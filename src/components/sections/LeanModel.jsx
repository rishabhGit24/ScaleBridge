        ...
        return (
            <section className="lean-section lean-section--mobile">
                <div className="lean-mobile-container">
                    <h2 className="lean-mobile-title">Lean Model</h2>
                    <p className="lean-mobile-subtitle">Agility and change management</p>
                    ...
                    <div className="lean-mobile-chart">
                        <img src={chart} alt="Lean Model Chart" />
                    </div>
                        ...
                        {services.map((service, index) => (
                            <div key={index} className="lean-mobile-service-block">
                                ...
                                <div className="lean-mobile-scope">
                                    <span className="lean-mobile-scope-label">Scope:</span>
